# JourneyClient
JourneyClient was a custom, made-from-scratch game client for older versions the MMORPG 'MapleStory'.
An active fork can be found [here](https://github.com/ryantpayton/MapleStory-Client). 
